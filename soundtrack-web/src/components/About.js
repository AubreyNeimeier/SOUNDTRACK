...
const About = (props) => {
        ...
        return (
            ...
            <p className="The Inspiration">The vision for this project, and it's close connection to Spotify</p>
...
GitHub: <a url="https://github.com/AubreyNeimeier"> GitHub Profile </a>
Blog : <a url="https://aubreyneimeier.github.io/"> Learn Blog </a> 
            </div>         
        )
    }
